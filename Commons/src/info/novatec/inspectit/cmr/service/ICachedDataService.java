...
public interface ICachedDataService {
	 ...
	 */
	IApplicationDefinition getApplicationDefinitionForId(short id);
	 ...
	 */
	IBusinessTransactionDefinition getBusinessTransactionDefinitionForId(short appId, short businessTxId);
