...
public interface IBusinessContextManagementService {
	...
	/**
	 * Retrieves the {@link IApplicationDefinition} for the given id.
	 *
	 * @param id
	 *            identifier of the application definition.
	 * @return Returns the {@link IApplicationDefinition} for the given id.
	 *
	 * @throws BusinessException
	 *             if adding {@link IApplicationDefinition} fails.
	 */
	IApplicationDefinition getApplicationDefinition(short id) throws BusinessException;
