...
public class EditApplicationHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selected instanceof IApplicationProvider) {
			...
			IApplicationDefinition applicationDefinition = applicationProvider.getApplication();
			...
			if (Dialog.OK == dialog.open()) {
				...
				try {
					repositoryDefinition.getBusinessContextMangementService().updateApplicationDefinition(applicationDefinition);
