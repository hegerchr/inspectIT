...
/**
 * Section part for the definition of {@link IExpression} instances.
 *
...
public class MatchingRulesPart extends SectionPart {
	...
	private void createClient(FormToolkit toolkit) {
		...
		matchingRuleComposite = new MatchingRulesEditingElement(getSection(), null);
	 ...
	 *            new {@link IExpression} to use as initialization
	 */
	public void changeInput(IExpression matchingRuleExpression) {
		matchingRuleComposite.reinitialize(matchingRuleExpression);
	}

	/**
	 * Constructs a matching rule from the contents of the underlying widgets.
	 *
	 * @return new {@link IExpression}.
	 */
	public IExpression constructMatchingRule() {
		return matchingRuleComposite.constructMatchingRuleExpression();
	}
