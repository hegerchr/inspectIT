...
public class DefineMatchingRuleWizardPage extends WizardPage {
	...
	public boolean isPageComplete() {
		return null != ruleComposite && null != ruleComposite.constructMatchingRuleExpression();
	}

	/**
	 * Constructs a {@link IExpression} instance from the widget input.
	 *
	 * @return a {@link IExpression} instance.
	 */
	public IExpression constructMatchingRule() {
		return ruleComposite.constructMatchingRuleExpression();
	}
