...
public class OpenApplicationDefinitionJob extends Job {
	 ...
	 *            defined in.
	 * @param applicationId
	 *            the id of the {@link IApplicationDefinition} to open the editor for.
	 * @param page
	 *            {@link IWorkbenchPage} to open editor in.
	 */
	public OpenApplicationDefinitionJob(CmrRepositoryDefinition cmrRepositoryDefinition, short applicationId, IWorkbenchPage page) {
	...
	protected IStatus run(IProgressMonitor monitor) {
		...
		IApplicationDefinition application;
		try {
